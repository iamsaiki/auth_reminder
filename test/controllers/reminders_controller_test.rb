...
class RemindersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reminder" do
    assert_difference('Reminder.count') do
      post reminders_url, params: { reminder: { body: @reminder.body, location: @reminder.location, private: @reminder.private, timings: @reminder.timings, title: @reminder.title, user_id: @reminder.user_id } }
    end
  ...
  test "should update reminder" do
    patch reminder_url(@reminder), params: { reminder: { body: @reminder.body, location: @reminder.location, private: @reminder.private, timings: @reminder.timings, title: @reminder.title, user_id: @reminder.user_id } }
